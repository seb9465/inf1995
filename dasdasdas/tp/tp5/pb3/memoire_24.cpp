                                ...
                                const uint8_t longueur)
{
  ...
  const uint8_t* copieDonnee = donnee;
  do
  {
      rv = ecrire_page(copieAdresse, copieDonnee, copieLongueur);
...
uint8_t Memoire24CXXX::ecrire_page(const uint16_t adresse, const uint8_t* donnee,
                                   const uint8_t longueur)
{
  uint16_t addr_fin;
  uint8_t rv = 0;
